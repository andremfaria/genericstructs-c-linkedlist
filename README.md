# genericstructs-c-linkedlist
A generic linked list writted in C language, that can be use in any C project. 


## Use example
Check Client.c. There is a full usage example.
## Interface
```c
/**
